...
public class LdapConfig
{
    ...
    @ConfigDescription("Ldap attribute containing user's login name. Example: user.name@domain.com")
    ...
    @ConfigDescription("Ldap attribute containing user's login name. Example: sAMAccountName")
